...
export default function AssignmentsDashboard() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await axios.get('https://backend-senasec-usyv.onrender.com/usuarios/', {
  ...
  useEffect(() => {
    const fetchFichas = async () => {
      try {
        const res = await axios.get('https://backend-senasec-usyv.onrender.com/fichas/fichas/', {
          headers: getAuthHeaders(),
        });
        setFichas(res.data);
      } catch (error) {
